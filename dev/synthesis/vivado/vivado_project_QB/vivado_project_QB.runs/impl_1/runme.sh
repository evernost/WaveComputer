...
HD_PWD='D:/recherche/projets/WaveComputer/dev/synthesis/vivado/vivado_project_QB/vivado_project_QB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_QB_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_QB_wrapper.tcl -notrace
