...
HD_PWD='D:/recherche/projets/WaveComputer/dev/synthesis/vivado/vivado_project_QB/vivado_project_QB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_QB_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_QB_wrapper.tcl
